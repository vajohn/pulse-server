...
public class PermissionCacheService {
    ...
    private static final Map<String, List<String>> ALL_EXPANSIONS = Map.ofEntries(
        ...
        Map.entry("ASSESS_ALL", List.of("ASSESS_READ","ASSESS_CREATE","ASSESS_UPDATE","ASSESS_DELETE","ASSESS_ASSIGN","ASSESS_KEY_MANAGE","ASSESS_RESULT_READ","ASSESS_COMPETENCY_MANAGE","ASSESS_APPROVE","ASSESS_ALL")),
